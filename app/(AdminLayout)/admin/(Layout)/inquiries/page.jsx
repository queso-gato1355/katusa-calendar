        ...
        <div className="space-y-4">
          {inquiries.map((inquiry) => (
            <Dialog
              key={inquiry.id}
              open={
                isDialogOpen && selectedInquiry?.id === inquiry.id
              }
            ...
            >
              <DialogTrigger asChild>
                ...
                >
                    ...
                    <div className="flex justify-between items-start">
                      <div className="space-y-2">
                        ...
                        <div className="hidden md:flex items-center gap-2 text-sm text-muted-foreground">
                          ...
                          <span>•</span>
                          <span className="truncate">{getInquiryTypeText(inquiry.type)}</span>
                          <span>•</span>
                  ...
                  <hr
                    className="mb-6 h-px border-t-0 bg-transparent bg-gradient-to-r from-transparent via-neutral-500 to-transparent opacity-25 dark:via-neutral-400"
                  />
                  <CardContent>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        placeholder="고객에게 보낼 응답을 작성해주세요..."
